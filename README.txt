...
Note: to execute problem two (the twitter one), you need to input your twitter credentials in Lightspeed/resources/configurations.yml


To execute tests, please enter "cucumber" from the Lightspeed/ directory.
